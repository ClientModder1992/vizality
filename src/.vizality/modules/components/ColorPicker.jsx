...
module.exports = AsyncComponent.from(
  (async () => {
    const DecoratedGuildSettingsRoles = getModuleByDisplayName('FluxContainer(GuildSettingsRoles)');
    const GuildSettingsRoles = DecoratedGuildSettingsRoles.prototype.render.call({ memoizedGetStateFromStores: () => void 0 }).type;
    const SettingsPanel = GuildSettingsRoles.prototype.renderRoleSettings.call({ props: { guild: { isOwner: () => true } }, renderHeader: () => null, getSelectedRole: () => '0' }).props.children[1].type;
