 ...
 * @returns {void}
 */
const _log = (module, submodule, submoduleLabelColor, message, type) => {
  const badgeColors = {
 ...
 * @returns {void}
 */
const log = (module, submodule, submoduleLabelColor, ...message) => {
  return _log(module, submodule, submoduleLabelColor, message);
};
 ...
 * @returns {void}
 */
const warn = (module, submodule, submoduleLabelColor, ...message) => {
  return _log(module, submodule, submoduleLabelColor, message, 'warn');
};
 ...
 * @returns {void}
 */
const error = (module, submodule, submoduleLabelColor, ...message) => {
  return _log(module, submodule, submoduleLabelColor, message, 'error');
};
 ...
 * @returns {void}
 */
const deprecate = (module, submodule, submoduleLabelColor, ...message) => {
  return _log(module, submodule, submoduleLabelColor, `Deprecation Notice: ${message}`, 'warn');
};

module.exports = { log, warn, error, deprecate };
