 ...
 */
const isString = (input, throwError = false) => {
...
module.exports = {
  isPlural, isSingular, toSingular, toPlural, isUrl, stripDiacritics, toCamelCase,
  toDotCase, toHeaderCase, toPathCase, toPascalCase, toSnakeCase, toKebabCase, isString,
  assertString
};
