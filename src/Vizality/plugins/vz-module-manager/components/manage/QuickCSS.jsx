...
class QuickCSS extends React.PureComponent {
  ...
  setupCodeMirror (cm) {
    ...
    cm.setValue(vizality.pluginManager.get('vz-module-manager')._quickCSS);
  ...
  _handleCodeMirrorUpdate (cm) {
    ...
    vizality.pluginManager.get('vz-module-manager')._saveQuickCSS(cm.getValue());
  }
...
module.exports = AsyncComponent.from((async () => {
  ...
  return Flux.connectStores([ windowStore, vizality.api.settings.store ], () => ({
    ...
    ...vizality.api.settings._fluxProps('vz-module-manager')
  }))(QuickCSS);
})());
