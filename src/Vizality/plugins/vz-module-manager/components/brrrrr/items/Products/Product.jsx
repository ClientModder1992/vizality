...
let classes = null;
setImmediate(() => classes = getModule('card', 'loaded'));

module.exports = class Product extends React.Component {
  render () {
    // @todo: proper data structure
    const { product: { manifest } } = this.props;
    return <div className='vizality-product'>
      <div className={classes.card}>
        <div className='vizality-product-abandonware'>Discontinued</div>
        ...
        {/* @todo metadata */}
        <div className='vizality-product-description'>{manifest.description}</div>
