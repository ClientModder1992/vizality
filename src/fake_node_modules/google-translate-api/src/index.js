/* eslint-disable */
// Forked from https://raw.githubusercontent.com/k3rn31p4nic/google-translate-api/, but uses Vizality's http module for less dependencies and node v7 support.
...
async function translate(text, options) {
  try {
    ...
    if (url.length > 2048) {
      delete data.q;
      response = await post(`${url}?${querystring.stringify(data)}`)
        .send({ q: text })
    }
    else {
