...
class Theme extends Updatable {
  ...
  async _compileStylesheet () {
    let stylesheet = await readFile(this._theme, 'utf8');
  ...
  _renderSCSS (rawScss) {
    return new Promise((res, rej) => {
      renderSCSS({
        data: rawScss,
        includePaths: [ dirname(this._theme) ],
        importer: (url, prev) => {
          ...
          const prevFile = prev === 'stdin' ? this._theme : prev.replace(/https?:\/\/(?:[a-z]+\.)?discordapp\.com/i, '');
          return {
