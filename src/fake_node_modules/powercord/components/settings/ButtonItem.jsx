  ...
  render () {
    ...
    return <DFormItem
      ...
      <div className='powercord-settings-item-title'>
        ...
        <Button
          color={this.props.success ? Button.Colors.GREEN : Button.Colors.BRAND} disabled={this.props.success}
          style={{ marginLeft: 5 }} onClick={() => this.props.onClick()}
        >
          {this.props.button}
        </Button>
      </div>
